 ...
 * ===========================================================
 * Benchmarks sha256mem_v4_tmto_gpu.cl (512 KiB/worker, consensus-equivalent
 * time–memory tradeoff) against sha256mem.c.
 *
 * Build:
...
int main(int argc, char **argv)
{
    ...
    printf("==================================================================\n");
    printf("     sha256mem TMTO GPU Benchmark — Fairchain PoW\n");
    printf("==================================================================\n");
    printf("  GPU:          %s\n", dev_name);
    printf("  Compute units: %u @ %u MHz\n", dev_cu, dev_freq);
    printf("  VRAM total:   %lu MiB\n", (unsigned long)(dev_gmem / (1024*1024)));
    printf("  Algorithm:     TMTO checkpoints (512 KiB/worker) + dual mix (2×32768)\n");
    printf("==================================================================\n\n");
